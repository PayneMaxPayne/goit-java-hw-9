...
public class UsersToJSON {
    ...
    private static final String PATH = "src/main/resources/fileGson.txt";
    private static final String PATH_TO_JSON = "src/main/resources/usersToJSON.json";

    public static void main(String[] args) {

        File fileGson = new File(PATH);
        File fileJson = new File(PATH_TO_JSON);
